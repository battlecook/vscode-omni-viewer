...
export const DOMUtils = {
    ...
    getElements: () => {
        return {
            ...
            visualizationModeButtons: document.querySelectorAll('[data-view-mode]'),
            spectrogramScaleGroup: document.getElementById('spectrogramScaleGroup'),
            ...
            channelDetailsInfo: document.getElementById('channelDetailsInfo'),
